...
public class CryptUtil {
    ...
    private void doEncrypt(
        ...
        Key secretKey = SecretKeygen.getSecretKey();
        if (secretKey == null) {
            ...
            cipher.init(operationMode, SecretKeygen.getSecretKey(), parameterSpec);
    ...
    public static Cipher initCipher() throws GeneralSecurityException {
        ...
        if (SDK_INT >= KITKAT) {
            ...
            cipher = Cipher.getInstance(ALGO_AES);
            cipher.init(Cipher.ENCRYPT_MODE, SecretKeygen.getSecretKey());
        }
        return cipher;
    }
}
